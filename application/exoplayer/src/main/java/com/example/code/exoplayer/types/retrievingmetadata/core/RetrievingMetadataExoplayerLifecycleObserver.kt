...
class RetrievingMetadataExoplayerLifecycleObserver (
    private val lifecycle: Lifecycle,
    private val context : Context,
    private val callback: (RetrievingMetadataExoplayerAction) -> Unit) : LifecycleObserver, Player.Listener {
    ...
    private fun initializePlayer(
        ...
        simpleExoplayer = SimpleExoPlayer.Builder(context)
            ...
            .also { exoPlayer ->
                ...
                callback.invoke(RetrievingMetadataExoplayerAction.BindCustomExoplayer(exoPlayer))
    ...
    override fun onPlayerStateChanged(playWhenReady: Boolean, playbackState: Int) {
        ...
        if (playbackState == Player.STATE_BUFFERING)
            callback.invoke(RetrievingMetadataExoplayerAction.ProgressBarVisibility(true))
