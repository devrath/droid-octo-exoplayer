...
class StyledExoplayerLifecycleObserver (
    private val lifecycle: Lifecycle,
    private val context : Context,
    private val callback: (StyledExoplayerAction) -> Unit) : LifecycleObserver, Player.Listener {
    ...
    private fun initializePlayer(
        ...
        simpleExoplayer = SimpleExoPlayer.Builder(context)
            ...
            .also { exoPlayer ->
                ...
                callback.invoke(StyledExoplayerAction.BindCustomExoplayer(exoPlayer))
    ...
    override fun onPlayerStateChanged(playWhenReady: Boolean, playbackState: Int) {
        ...
        if (playbackState == Player.STATE_BUFFERING)
            callback.invoke(StyledExoplayerAction.ProgressBarVisibility(true))
        else if (playbackState == Player.STATE_READY || playbackState == Player.STATE_ENDED)
            callback.invoke(StyledExoplayerAction.ProgressBarVisibility(false))
    }
